...
public:
    ...
    void setupUi(QWidget *ReceiveFile)
    {
        ...
        label->setGeometry(QRect(10, 20, 491, 31));
        okBtn = new QPushButton(bodyWidget);
        okBtn->setObjectName(QString::fromUtf8("okBtn"));
        okBtn->setGeometry(QRect(170, 70, 93, 28));
        cancelBtn = new QPushButton(bodyWidget);
        cancelBtn->setObjectName(QString::fromUtf8("cancelBtn"));
        cancelBtn->setGeometry(QRect(320, 70, 93, 28));
    ...
    void retranslateUi(QWidget *ReceiveFile)
    {
        ...
        label->setText(QCoreApplication::translate("ReceiveFile", "\346\235\245\350\207\252xxx\345\217\221\346\235\245\347\232\204\346\226\207\344\273\266\357\274\232\346\230\257\345\220\246\346\216\245\346\224\266", nullptr));
