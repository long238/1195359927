...
public:
    ...
    void setupUi(QWidget *TalkWindow)
    {
        ...
        sysclose->setContextMenuPolicy(Qt::DefaultContextMenu);
        ...
        horizontalSpacer = new QSpacerItem(650, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        treeWidget->setGeometry(QRect(0, 10, 280, 355));
    ...
    void retranslateUi(QWidget *TalkWindow)
    {
        ...
        sysmin->setToolTip(QCoreApplication::translate("TalkWindow", "\346\234\200\345\260\217\345\214\226\346\226\207\346\234\254", nullptr));
